...
/** Whole-player vitals grouped into read-only snapshots: pain shock, consciousness, circulation
  ...
  * opioid scalars. Immune health ranges from 0 to its fixed maximum of 200; consciousness level,
  * pain-shock load, and blood oxygen from 0 to their constants below; adrenaline ranges up to 100;
