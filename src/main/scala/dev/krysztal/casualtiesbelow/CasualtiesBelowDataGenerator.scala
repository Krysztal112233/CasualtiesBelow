...
object CasualtiesBelowDataGenerator extends DataGeneratorEntrypoint {
  ...
  override def onInitializeDataGenerator(generator: FabricDataGenerator): Unit = {
    ...
    pack.addProvider[BiomeTagProvider]((output, registries) => BiomeTagProvider(output, registries))
    ...
    pack.addProvider[AssetModelProvider]((output, registries) => new AssetModelProvider(output))
  }
